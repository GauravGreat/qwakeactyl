...
echo done you will if you need any help in configuring qwakeactyl join our discord https://discord.gg/eBBKeuB7p2

echo and you will have to do settings.json
